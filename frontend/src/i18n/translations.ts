...
export const translations = {
  'zh-CN': {
    ...
    lineHeight: '行距',
    lineHeightSingle: '单倍行距',
    lineHeight1_15: '1.15倍行距',
    lineHeight1_5: '1.5倍行距',
    lineHeightDouble: '双倍行距',
    addLink: '添加链接',
    removeLink: '移除链接',
    linkUrl: '链接地址',
    undo: '撤销',
  ...
  'en-US': {
    ...
    insertDiv: 'Insert DIV',
    insertSpan: 'Insert SPAN',
    insertBreak: 'Insert Break',
    insertH1: 'Insert Heading 1',
    insertH2: 'Insert Heading 2',
    insertH3: 'Insert Heading 3',
    insertBulletList: 'Insert Bullet List',
    insertOrderedList: 'Insert Ordered List',
    insertBlockquote: 'Insert Blockquote',
    enterFullscreen: 'Fullscreen Edit',
    ...
    appPermissions: 'This app will get the following permissions',
    approve: 'Authorize',
    deny: 'Deny',
  }
} as const;